#!/bin/sh
seriationct-export-data.py --experiment seriationct-19 --outputdirectory exported-data
seriationct-assemblage-duration-export.py --experiment seriationct-19 --outputdirectory temporal
