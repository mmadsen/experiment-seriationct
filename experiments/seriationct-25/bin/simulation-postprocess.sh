#!/bin/sh
seriationct-export-data.py --experiment seriationct-25 --outputdirectory exported-data
seriationct-assemblage-duration-export.py --experiment seriationct-25 --outputdirectory temporal
