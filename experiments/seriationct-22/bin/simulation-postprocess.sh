#!/bin/sh
seriationct-export-data.py --experiment seriationct-22 --outputdirectory exported-data
seriationct-assemblage-duration-export.py --experiment seriationct-22 --outputdirectory temporal
