#!/bin/sh
seriationct-export-data.py --experiment seriationct-23 --outputdirectory exported-data
seriationct-assemblage-duration-export.py --experiment seriationct-23 --outputdirectory temporal
